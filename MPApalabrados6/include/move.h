...
#ifndef MOVE_H
#define MOVE_H
#define UNKNOW              -1 // Error generico (main?)
#define BOARD_OVERFLOW      -2 // La tirada sale del tablero (tiles-main)
#define NONEXISTENT_WORD    -3 // La palabra de la tirada no aparece en el diccionario (move-findScore)
#define INFEASIBLE_WORD     -4 // La palabra de la tirada no es compatible con player (main)
#define NOT_FREE            -5 // La palabra empieza en una celda que ya esta ocupada (tiles-main)
#define MISSING_CROSSWORDS  -6 // La palabra no se cruza con ninguna otra (tiles-main)
