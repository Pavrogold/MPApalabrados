...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados6

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados6: ../local/lib/liblanguage.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados6: ../local/lib/libansiterminal.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados6: ../local/lib/libwordlist.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados6: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados6 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/movelist.o: src/movelist.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I../local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/movelist.o src/movelist.cpp
...
${OBJECTDIR}/src/tiles.o: src/tiles.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I../local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tiles.o src/tiles.cpp
