...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados5

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados5: ../local/lib/liblanguage.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados5: ../local/lib/libansiterminal.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados5: ../local/lib/libwordlist.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados5: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpapalabrados5 ${OBJECTFILES} ${LDLIBSOPTIONS}
